...
class GalleryContentAdoptionTest extends TestCase
{
     ...
     * НЕ даёт права удалить строку `ok_images` и файл клиента. Осиротевшая строка галереи видна в
     * галерее и снимается РУКАМИ (свипа по строкам `ok_images` без durable-владельца в модуле нет:
     * все удаления идут по известному `image_id`); следующий прогон её не размножает. Удалённый
     * файл клиента не вернуть ничем.
     */
